...
//
//public class PowerVmAllocationPolicyThermalOptimalSolver extends PowerVmAllocationPolicyMigrationAbstract{
//
//    double parameter = 0;
//
...
//    public PowerVmAllocationPolicyThermalOptimalSolver(List<? extends Host> hostList,
...
//                    double[] lb = {0};
//                    double[] ub = {1};
//                    IloNumVar[] x = cplex.numVarArray(1, lb, ub);
//                    double[] objVals = {}; // coefficients
//
////                        cplex.importModel("aflow40b.mps");
////                        cplex.solve();
//
//                }
//
...
//    }
//
//    protected  void cplexModelSolver(){
//
//        try{
