...
public class Cloudlet {
	...
	/** @Author Shashi- Associate workload file path to the cloudlet from where we associated Utilization model*/

	public String utilizationModelWorkloadFilePath = null;
	/**
...
/** !Author Shashi- Thermal Cloudlet*/
	...
	public Cloudlet(
			...
			final UtilizationModel utilizationModelRam,
			final UtilizationModel utilizationModelBw,
			String utilizationModelWorkloadFilePath
			) {
		this(
				cloudletId,
				cloudletLength,
		...
		accumulatedBwCost = 0.0;
		costPerBw = 0.0;
		this.utilizationModelWorkloadFilePath = utilizationModelWorkloadFilePath;
	}
	...
	public  String getUtilizationModelWorkloadFilePath(){
		return  this.utilizationModelWorkloadFilePath;
	}
