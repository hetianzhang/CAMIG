 ...
 * @since Jan 5, 2012
 */
public class ThermalRunner extends RunnerAbstract {
	...
	protected void init(String inputFolder) {
		try {
			...
			cloudletList = PlanetLabHelper.createCloudletListPlanetLab(brokerId, inputFolder); //ThermalHelper.createCloudletList(brokerId, ThermalConstants.NUMBER_OF_VMS);
			vmList = Helper.createVmList(brokerId, cloudletList.size());
			hostList = Helper.createHostList(ThermalConstants.NUMBER_OF_HOSTS);
		} catch (Exception e) {
			e.printStackTrace();
