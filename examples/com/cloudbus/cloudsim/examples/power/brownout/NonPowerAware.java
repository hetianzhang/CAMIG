...
public class NonPowerAware {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			List<Cloudlet> cloudletList = BrownoutHelper.createCloudletList(
					brokerId,
					BrownoutConstants.NUMBER_OF_VMS);
			List<Vm> vmList = Helper.createVmList(brokerId, cloudletList.size());
			List<PowerHost> hostList = Helper.createHostList(BrownoutConstants.NUMBER_OF_HOSTS);
